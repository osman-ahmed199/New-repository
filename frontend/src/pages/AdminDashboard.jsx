      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex gap-4 mb-6">
          ...
          <button onClick={() => setActiveTab('tickets')}
            className={`px-4 py-2 rounded ${activeTab === 'tickets' ? 'bg-blue-600 text-white' : 'bg-white border'}`}>
            كل التذاكر
          </button>
        </div>
              ...
              <tbody>
                {tickets.map(t => (
                  ...
                  >
                    ...
                    <td className="p-3">{new Date(t.created_at).toLocaleDateString('ar')}</td>
                  </tr>
                ))}
              </tbody>
            </table>
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  <div>
                    ...
                    <div className="text-sm">{selectedTicket.priority}</div>
                  </div>
                  <div>
